...
import static dev01.pkg8x2.DEV018x2B.CAT;
import static dev01.pkg8x2.DEV018x2B.EIG1;
import static dev01.pkg8x2.DEV018x2B.EIG2;
import static dev01.pkg8x2.DEV018x2B.ReadText;
    ...
    public void draw() {
        ...
        try {
            for (int i = 0; i < ANA.size(); i++) {
                Convert((double) ANA.get(i), (double) DEV.get(i));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
